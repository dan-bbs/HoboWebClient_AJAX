...
#define CONNECTION_LED D0 // Connection LED pin (Built in). -1 to disable
...
#define SET_CALLBACK_SIGNATURE std::function<void(AsyncWebServerRequest *request)> setcallback
...
public:
    ...
    AsyncFSWebServer& setSETCallback(SET_CALLBACK_SIGNATURE);
